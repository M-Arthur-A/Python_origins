...
данных атрибутов должны передаваться при создании экземпляра класса. Атрибуты сделать защищенными.
...
class Road:
    ...
    def calc_mass(self, mass=25, height=5):
        self.road_mass = self._length * self._width * mass * height
